...
# N целых чисел. Каждое число – среднесуточная температура в 
# соответствующий день. Температуры – целые числа и лежат в диапазоне 
# от –50 до 50 
# Input:    6 -> -20 30 -40 50 10 -10 Output: 2
import random


days_count = int(input('Введите количество наблюдаемых дней: '))
count = 0
max_count = 0
...
print(f'\n\nЗа {days_count} дней максимальная оттепель была {max_count} дней')
